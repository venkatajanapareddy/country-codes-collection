 ...
 */
export const countriesMap: Readonly<Record<CountryCodeA2, Country>> =
  Object.freeze(Object.fromEntries(countries.map((c) => [c.codeA2, c])));
...
export function getCountryByCode(
  ...
  return (
    countries.find((c) => c.codeA2 === codeNorm || c.codeA3 === codeNorm) ||
    undefined
  );
}
